...
num_array = []
while True:
    inp_data = input('Введите произвольное число и нажмите Enter (для остановки введите слово "stop")\n')
    if inp_data == 'stop':
        break
    else:
        try:
            if not inp_data.isdigit():
                raise NotNumber("Допустимы только числа!")
            num_array.append(inp_data)
        except NotNumber as e:
            print(e)
print(f"Сформированный список: {num_array}")
